...
<head>
    ...
    <link rel="stylesheet" href="assetes/CSS/booking.css">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="right-side">
                    <h3 class="right-text">Classic Paragliding</h3>
                    <!-- <div class="right-img">
                         ...
                         <!-- child and adult end-->
                          ...
                          <div class="container1"  style="margin-top:150px;">
                              ...
                              <div class="col-md-10 bg-white p-3 rounded shadow">
                                  <div class="col-12">
                                      <h3 class="text-center font-weight-bold  txt">Classic Paragliding</h3>
                                  </div>
                                  <div class="col-6">
                                  ...
                                  <div class="col-12 p-3">
                                      <a href="https://rzp.io/l/helicopterridekanyakumari" class="button-primary pay_now ">Pay NOW</a> 
                                  </div>
                              </div>
                          </div>
                       </div>
